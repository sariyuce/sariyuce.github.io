---
layout: post
title: "Why GraphRAG Needs a Better Backbone Than Leiden Clustering"
date: 2026-03-10
description: 
tags: []
categories: []
...
{% include figure.liquid path="assets/img/kcore-example.png" caption="K-core
  decomposition layers (left) and the resulting hierarchy tree (right)." %}
