...
Two seasons in a row now, across all three UEFA continental competitions, the same structural risk keeps producing the same kind of little pit somewhere on the fixture list. It's not an odd year. It's the format. All three new draws are loaded into the [interactive tool](https://sariyuce.github.io/assets/uefa-draws/).
